...
export default function EditStudent(){
    ...
    return(
        ...
        <form onSubmit={handleSubmit}>
            ...
            <input type="text" id="email" name="email" required value={email} onChange={e=>setEmail(e.target.value)} onMouseDown={()=>setValidation(true)}/>
            {email.length===0 && validation && <span className="errorMsg">Please Enter Your Email Id</span>}
